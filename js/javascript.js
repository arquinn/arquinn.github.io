...
$('#brect').addClass("brect")
$('.beer').addClass("beerdesktop")
$('li.question').addClass("questiondesktop")
// device detection
...
{
    isMobile = true;
    $('#brect').removeClass("brect").addClass("brectmobile")
    $('.beer').removeClass("beerdesktop").addClass("beermobile")
    $('li.question').removeClass("questiondesktop").addClass("questionmobile")

    
    var multiple = new Multiple({
        selector: ".beer",
        background: 'url("../FINAL_LOGO_GREY.jpg")',
    });
}
